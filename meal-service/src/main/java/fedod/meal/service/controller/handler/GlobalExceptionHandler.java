package fedod.meal.service.controller.handler;

import fedod.meal.service.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDishNotFound(
        ...
        log.warn("Dish not found: {}", ex.getMessage());
        return buildResponse(HttpStatus.NOT_FOUND, "Dish not found", ex.getMessage(), request.getRequestURI(), List.of());
    }
