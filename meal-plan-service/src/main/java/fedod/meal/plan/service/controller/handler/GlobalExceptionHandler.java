package fedod.meal.plan.service.controller.handler;

import fedod.meal.plan.service.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleMealPlanNotFound(
            MealPlanNotFoundException ex,
            HttpServletRequest request
    ) {
        log.warn("Meal plan not found: {}", ex.getMessage());
        return buildResponse(HttpStatus.NOT_FOUND, "Meal plan not found", ex.getMessage(), request.getRequestURI(), List.of());
    }
